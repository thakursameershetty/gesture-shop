...
export const ProductCard = forwardRef(({ product, isDragging, style }, ref) => {
  return (
    <motion.div 
      ...
      style={style}
      // REMOVED 'max-w-[300px]' -> Added 'w-full'
      className={`
        bg-white rounded-[32px] p-4 w-full shadow-lg relative select-none border border-gray-100
        ${isDragging ? 'cursor-grabbing shadow-2xl z-50 ring-2 ring-[#00e5ff]' : 'hover:shadow-xl transition-shadow'}
      `}
